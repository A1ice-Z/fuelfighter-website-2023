    ...
    return (
        <div className="homeContainer" style={{position: 'relative'}}>
            ...
            <div className="applyField">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-evenly', marginTop: '5vh', overflow: 'hidden'}}>
                    ...
                    <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FFuelFighterNTNU%2Fposts%2Fpfbid02KxZ6aZwdVmNK96yaa4rUyr2tHEou8jGjfBoUciuB1JsqSGpu5nGyYEpifRh8Jmkwl&show_text=true&width=500" width="500" height="450" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>    
                </div>
        </div>
    )
}